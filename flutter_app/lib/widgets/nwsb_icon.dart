...
class NwsbMarks {
  ...
  /// Settings cog — header and menus. Stroke only, 24 box.
  static const gear = '<circle cx="12" cy="12" r="3"/>'
  ...
  /// Account mark for the menu.
  static const user = '<circle cx="12" cy="8" r="3.2"/>'
