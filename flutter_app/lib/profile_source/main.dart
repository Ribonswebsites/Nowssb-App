...
class _ProfilePageState extends State<ProfilePage> with TickerProviderStateMixin {
  ...
  Widget _banner() => Container(
        ...
        decoration: BoxDecoration(
          ...
          image: const DecorationImage(image: AssetImage('assets/images/img-banner.png'), fit: BoxFit.cover),
        ),
            ...
            children: [
              SizedBox(
                ...
                child: Stack(children: [
                  ...
                  Positioned.fill(child: Opacity(opacity: .98, child: Image.asset('assets/images/img-ring.png', fit: BoxFit.cover, alignment: const Alignment(.0, -.16)))),
  ...
  Widget _progress() => GlassCard(
        ...
        image: 'assets/images/img-progress.png',
  ...
  Widget _about() => GlassCard(
        ...
        image: 'assets/images/img-about.jpeg',
  ...
  Widget _quickAccess() => SectionBlock(
        ...
        child: GlassCard(
          ...
          image: 'assets/images/img-qa.jpeg',
  ...
  Widget _recentActivity() {
    final data = [('Morning Calm', 'Guided Meditation', '2h ago', 'assets/images/img-act1.jpeg'), ('Deep Breathing', 'Breathwork Session', '1d ago', 'assets/images/img-act2.jpeg'), ('Body Scan', 'Sleep Wind-Down', '3d ago', 'assets/images/img-act3.jpeg')];
    return SectionBlock(
      marginBottom: 40,
  ...
  Widget _motto() => GlassCard(
        ...
        image: 'assets/images/img-motto.jpeg',
  ...
  Widget _quote() => GlassCard(
        ...
        image: 'assets/images/img-quote.jpeg',
  ...
  Widget _recentSheet() => Stack(children: [
        ...
        Align(alignment: Alignment.bottomCenter, child: SafeArea(top: false, child: Padding(padding: const EdgeInsets.all(16), child: _AnimatedSheet(child: GlassCard(radius: 28, padding: const EdgeInsets.all(20), backgroundColor: const Color(0xE60A0A0C), child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          GridView.count(shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), crossAxisCount: MediaQuery.sizeOf(context).width <= 360 ? 1 : 2, crossAxisSpacing: 10, mainAxisSpacing: 10, childAspectRatio: 2.55, children: const [
            _MoreCard('Evening Reset', 'Guided Meditation · 4d ago', 'assets/images/img-act1.jpeg'), _MoreCard('Box Breathing', 'Breathwork · 5d ago', 'assets/images/img-act2.jpeg'), _MoreCard('Night Drift', 'Sleep Wind-Down · 6d ago', 'assets/images/img-act3.jpeg'), _MoreCard('Focus Flow', 'Mindfulness · 7d ago', 'assets/images/img-motto.jpeg'),
          ]),
        ])))))),
      ]);
}
