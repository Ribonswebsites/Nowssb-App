...
const _bg = AssetImage('assets/profile_source/img-bg.jpeg');
const _ring = AssetImage('assets/profile_source/img-ring.png');
const _motto = AssetImage('assets/profile_source/img-motto.jpeg');
const _about = AssetImage('assets/profile_source/img-about.jpeg');
const _quote = AssetImage('assets/profile_source/img-quote.jpeg');
const _quick = AssetImage('assets/profile_source/img-qa.jpeg');
const _activity = AssetImage('assets/profile_source/img-act1.jpeg');
const _progress = AssetImage('assets/profile_source/img-progress.png');
const _banner = AssetImage('assets/profile_source/img-banner.png');
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget _imagePanel(ImageProvider image, Widget child) => Container(width: double.infinity, decoration: BoxDecoration(borderRadius: BorderRadius.circular(22), border: Border.all(color: const Color(0x55FFFFFF)), image: DecorationImage(image: image, fit: BoxFit.cover, colorFilter: const ColorFilter.mode(Color(0xD9000000), BlendMode.darken)), boxShadow: const [BoxShadow(color: Color(0x88000000), blurRadius: 28, offset: Offset(0, 12)), BoxShadow(color: Color(0x22000000), blurRadius: 4, spreadRadius: 1)]), child: ClipRRect(borderRadius: BorderRadius.circular(22), child: BackdropFilter(filter: ui.ImageFilter.blur(sigmaX: 18, sigmaY: 18), child: Container(color: const Color(0x260B0B10), child: child))));
  Widget _panel(Widget child) => Container(width: double.infinity, padding: const EdgeInsets.all(18), decoration: BoxDecoration(color: const Color(0xCC0D0D10), borderRadius: BorderRadius.circular(24), border: Border.all(color: const Color(0x55FFFFFF)), boxShadow: const [BoxShadow(color: Color(0x88000000), blurRadius: 28, offset: Offset(0, 12)), BoxShadow(color: Color(0x22000000), blurRadius: 4, spreadRadius: 1)]), child: ClipRRect(borderRadius: BorderRadius.circular(18), child: BackdropFilter(filter: ui.ImageFilter.blur(sigmaX: 20, sigmaY: 20), child: Container(color: const Color(0x260B0B10), child: child))));
}
