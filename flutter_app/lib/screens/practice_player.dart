...
class _GlassTube extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final playSize = height >= 110 ? 58.0 : 50.0;
    return SizedBox(
      height: height,
      child: DecoratedBox(
        decoration: const BoxDecoration(
      ...
      overlay: Row(
        children: [
          ...
          Expanded(
            child: _WordAction(
              svg:
                  '<rect x="9" y="2.6" width="6" height="11.2" rx="3"/><path d="M5.5 11.4a6.5 6.5 0 0 0 13 0"/><path d="M12 17.9v3.5M8.6 21.4h6.8"/>',
              label: 'Practice',
              onTap: onPractice,
              accent: accent,
            ),
                  ...
                  children: [
                    ...
                    if (word.parts.isNotEmpty)
                      _noteBlock(
                        'SOUND MAP',
                        word.parts
                            .map((p) => p.roman.isNotEmpty ? p.roman : p.deva)
                            .join('  ·  '),
                      ),
                    const SizedBox(height: 4),
                    Container(
