...
assert.match(index, /<iframe src="app\/widgets\/neumorphic-essentials\.html"/, "WebView must use the supplied essentials file directly");
...
assert.match(essentials, /nowssb-essentials-resize/, "Essentials must request an iframe height refresh after expanding");
...
assert.match(index, /nowssb-essentials-resize/, "Normal Home must resize the essentials iframe after expansion");
