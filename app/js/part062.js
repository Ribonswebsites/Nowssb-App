  ...
  var REG = {
    nm: {
      ...
      items: [
        ...
        { k:'trendban', sel:['.nmh-sec-banner'], t:B, label:"Today's Trending", sub:'Banner above the trending word' },
        { k:'trendwd',  sel:['.vb-banner[data-vb="vb6"]', '#nmh-trending-section'],                                     t:S, label:'Trending Word',         sub:'The word healing the most today' },
        ...
        { k:'healing',  sel:['.vb-banner[data-vb="vb2"]', '.health-journey-card'],                                      t:S, label:'Personalised Healing',  sub:'Choose your health journey', always:1 },
    ...
    fash: {
      ...
      items: [
        ...
        { k:'trendwd',  sel:['.vb-banner[data-vb="vb7"]', '.fash-trend-wrap'],                                          t:S, label:"Today's Trending",      sub:'The trending word and its shop banner' },
        ...
        { k:'healing',  sel:['.vb-banner[data-vb="vb3"]', '.health-journey-card'],                                      t:S, label:'Personalised Healing',  sub:'Choose your health journey', always:1 },
