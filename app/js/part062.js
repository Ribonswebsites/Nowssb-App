  ...
  var REG = {
    nm: {
      ...
      items: [
        ...
        { k:'qa',       sel:['.nmh-qa-banner'],                                            t:B, label:'Quick Access',          sub:'Bottom navigation banner' },
        ...
        { k:'trendban', sel:['.nmh-sec-banner:not(.nmh-qa-banner):not(.nmh-qlinks-banner):not(.nmh-layout-banner)'], t:B, label:"Today's Trending", sub:'Banner above the trending word' },
        ...
        { k:'wsvid',    sel:['.nmh-video-banner-search'],                                  t:B, label:'Word Search Video',     sub:'Video banner above Word Search' },
        ...
        { k:'qlinks',   sel:['.nmh-qlinks-banner'],                                        t:B, label:'Quick Links',           sub:'One-tap shortcuts sheet' },
        { k:'layout',   sel:['.nmh-layout-banner'],                                        t:B, label:'Set As You Like',       sub:'This editor', always:1 },
    ...
    fash: {
      ...
      items: [
        ...
        { k:'qlinks',   sel:['.fash-qlinks-banner'],                                       t:B, label:'Quick Links',           sub:'One-tap shortcuts sheet' },
        { k:'layout',   sel:['.fash-layout-banner'],                                       t:B, label:'Set As You Like',       sub:'This editor', always:1 },
        ...
        { k:'feed',     sel:['#ncbCarouselFash'],                                          t:S, label:'Community Carousel',    sub:'Swipeable feed cards' },
        ...
        { k:'healing',  sel:['.health-journey-card'],                                      t:S, label:'Personalised Healing',  sub:'Choose your health journey' },
        { k:'wsvid',    sel:['.fash-video-banner-search'],                                 t:B, label:'Word Search Video',     sub:'Video banner above Word Search' },
