...
var SUB = {
  ...
  'sound-library':{eye:'Sound Library',h:'Your word collection',b:'How to navigate:',steps:['Chips along the top filter the whole page — All, Sentences, My Words, Purchased, then every category.','Speed dial and Quick picks are your words; tap any to open it in the player.','Your sentences holds everything you have built; tap to play.']},
