        ...
        '<div class="cwp-item-right">' +
          ...
          '<div class="cwp-item-actions">' +
            '<div class="cwp-item-btn gold" title="Save to wishlist" onclick="cwpCartToWish(\'' + safeId + '\',\'' + safeName + '\',' + item.price + ',\'' + (item.img||'').replace(/'/g,"\\'") + '\',\'' + (item.type||'Word') + '\')">' +
              '<img class="cw-svg-img" src="https://media.nowssb.com/migrated-images/e5cf26d9ba2b3fb0_20d73d50-56cc-11f1-9352-7b4e59e4b0d9_xp7xwq.png" alt="Wishlist" style="width:20px;height:20px;object-fit:contain;display:block;">' +
            '</div>' +
        ...
        '<div class="cwp-item-right">' +
          ...
          '<div class="cwp-item-actions">' +
            '<div class="cwp-item-btn gold" title="Move to cart" onclick="cwpWishToCart(\'' + safeId + '\')">' +
              '<img class="cw-svg-img" src="https://media.nowssb.com/migrated-images/f0b0ce0012f71cff_c9c4e860-56cf-11f1-8fad-095787cce754_t6k8gb.png" alt="Move to cart" style="width:20px;height:20px;object-fit:contain;display:block;">' +
            '</div>' +
...
window.wishOpenListFromIntro = function(type) {
  ...
  if (type === 'words') {
    ...
    if (heroBg)    { heroBg.style.backgroundImage = "url('https://media.nowssb.com/migrated-images/e0ccbdeda57846de_grok_image_1778783018581_aeitdi.jpg')"; heroBg.style.backgroundPosition = 'center top'; }
    ...
    if (heroBg)    { heroBg.style.backgroundImage = "url('https://media.nowssb.com/migrated-images/47b5ce86758a0234_grok_image_1778773657342_pdufwz.jpg')"; heroBg.style.backgroundPosition = 'center top'; }
    if (heroOvl)   heroOvl.style.background = 'none';
  }
