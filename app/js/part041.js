...
(function(){
  ...
  if(!oldPanel) return;
  oldPanel.innerHTML = `
    <div class="nwsb-pe-cover" style="position:relative;width:100%;height:172px;background:#0a0a14 url('https://media.nowssb.com/migrated-images/f7e0b23df165dd82_grok_image_1784171046763_kfygmv.jpg') center/cover no-repeat;">
      ...
      <div>
        ...
        <div style="display:flex;gap:12px;">
          <button type="button" id="nwsb-theme-neu" class="nwsb-theme-opt" onclick="nwsbSetSocTheme('neu')">
            <div class="nwsb-theme-opt-img" style="background-image:url('https://media.nowssb.com/migrated-images/f7ab49ce96814d9d_file_00000000a718720aaba9aef2f7b1e757_sdk2a8.png')"></div>
          ...
          <button type="button" id="nwsb-theme-glass" class="nwsb-theme-opt" onclick="nwsbSetSocTheme('glass')">
            <div class="nwsb-theme-opt-img" style="background-image:url('https://media.nowssb.com/migrated-images/4ab7671cefecf91e_file_00000000cf8c720a89a1fb6f44fe8c55_xwdwnz.png')"></div>
