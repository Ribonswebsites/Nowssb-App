...
(function () {
  ...
  function render(block) {
    ...
    block.innerHTML = '<div class="nwsb-subscription-page"><div class="nwsb-sub-tv-frame"><div class="nwsb-sub-tv-screen">' +
      ...
      '<button class="nwsb-sub-upgrade-banner" type="button" onclick="if(window.SS)SS.open(\'subscription\')"><span class="nwsb-sub-banner-copy"><strong>Join NowssB</strong><small>Join today · Choose your frequency</small></span><span>' + arrow() + '</span></button>' +
