...
(function () {
  ...
  function renderOffersPage() {
    ...
    var couponImg = 'https://nowssb-api.ribonpatil2.workers.dev/media/media/repo/assets/icons/logo-disc.webp';
    ...
    var wordImg = 'https://nowssb-api.ribonpatil2.workers.dev/media/media/repo/assets/icons/logo-disc.webp';
  ...
  function streakBannerHtml() {
    ...
    return '<div class="nmh-sec-banner" id="streakProfileBanner" onclick="openSub(\'streak\')">' +
      '<div class="nmh-sec-banner-icon"><img loading="lazy" decoding="async" src="https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/f82047a0e727766b375647daaff93ba2784f6ac0ecf6c3f9b207639c3444529f.png" alt="" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"></div>' +
  ...
  var FEAT_BANNER_CARDS = [
    { name: 'Everything NowssB', sub: 'Quick access to everything on NowssB', img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/af0736f58e0c29f3ee1124c2298b8d90cb7cc5a5f5a99f3f531ac5d481eba949.webp' },
    { name: 'NowssB Player',    sub: 'Your sound library — listen, heal, repeat',           img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/2ab8b4bbd1a045b068da1fb6b6781158ca16fa948a8a67f1038b8449f5499996.webp' },
    { name: 'NowssB Connect',   sub: 'The social space of NowssB — share your journey',     img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/8ed93fdc651b43c37f9808dbd165222aeaa1bf68f6a95814aa3e04e3c95b40e8.webp' },
    { name: 'NowssB Store',     sub: 'Words & meanings — own the sounds that heal',         img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/0781e6ce59dee3786df7b018f21f97d8c6cf83421f18799104f32d940d2da9d9.webp' },
    { name: 'Verification',     sub: 'Earn your NowssB check-mark',                          img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/4941ad0e531fcc53b3a9fb315a42d97c3c2e0e7c663d55f2378df28d1a2b3a45.webp' },
    { name: 'Search',           sub: 'Find any word or meaning, instantly',                  img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/8d85320f63c3e1760c436ecb735a892202453e58b9a36178183dc6c2d7f72be4.webp' },
    { name: 'Daily Practice',   sub: 'Your morning ritual, every day',                        img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/73217a0bd6f399ea4515768d2e5716dcd9af0576c699084606e65682a19a1357.webp' },
    { name: 'Word Science',     sub: 'The NOWSBANSIU system, decoded',                        img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/dd44cf9fc35b783c2e30a7d85cff2f88eeca40d929d9fe19db47b941586210f7.webp' },
    { name: 'My Progress',      sub: 'Track your healing journey',                            img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/0480c10b8a8d79dd38f0f5ffaf71f982cb92d7e49b8cbb3a9bd93bc6820c8a99.webp' },
    { name: 'Wishlist',         sub: 'Words you\'ve saved for later',                         img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/a74a9935fb237eb82b17a92169d2b57e5a8733d5a3fd699754717fcd8869dfed.webp' },
    { name: 'Cart',             sub: 'Your bag, ready for checkout',                          img: 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/311c26afee2bc52c712ebb6fcce54014ce10264bcb6805954a9f3b45a9c99c5d.webp' }
  ];
  ...
  var RX_WORD_ICON = 'https://nowssb-api.ribonpatil2.workers.dev/media/media/cloudinary/0781e6ce59dee3786df7b018f21f97d8c6cf83421f18799104f32d940d2da9d9.webp';
